        ...
        <div class="modal-content" style="border-radius: 15px; border: none; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3);">
            <div class="modal-header" style="background: #941022; color: white; border-radius: 15px 15px 0 0;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title mb-0" id="bloodCollectionModalAdminLabel">Blood Collection (Admin)</h5>
                    ...
                    <div class="blood-step-content-admin active" id="blood-step-2-admin" data-step="2">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="blood-unit-serial-admin" class="form-label">Unit Serial Number *</label>
                                <input type="text" class="form-control" id="blood-unit-serial-admin" name="unit_serial_number" readonly>
                                <div class="form-text">Auto-generated</div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Collection Date</label>
                                <input type="text" class="form-control" id="blood-collection-date-admin" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="blood-type-display-admin" class="form-label">Blood Type</label>
                                <input type="text" class="form-control" id="blood-type-display-admin" name="blood_type" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="donor-weight-admin" class="form-label">Donor Weight (kg)</label>
                                <input type="number" class="form-control" id="donor-weight-admin" name="donor_weight" min="50" max="200">
                            </div>
                        </div>
                    </div>

                    <!-- Step 3: Timing (editable text, not read-only) -->
                    <div class="blood-step-content-admin" id="blood-step-3-admin" data-step="3" style="display: none;">
                        <div class="blood-step-title mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="blood-end-time-admin" class="form-label">End Time *</label>
                                <input type="time" class="form-control" id="blood-end-time-admin" name="end_time" required>
                            </div>
                        </div>
                    </div>

                    <!-- Step 4: Review -->
                    <div class="blood-step-content-admin" id="blood-step-4-admin" data-step="4" style="display: none;">
                        <div class="blood-step-title mb-4">
                        ...
                        <div class="collection-summary" style="background: #f8f9fa; border-radius: 10px; padding: 1.5rem;">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p><strong>Start Time:</strong> <span id="summary-start-time-admin">-</span></p>
                                    <p><strong>End Time:</strong> <span id="summary-end-time-admin">-</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer" style="background: #f8f9fa; border-radius: 0 0 15px 15px;">
                <div class="d-flex justify-content-between w-100">
                    <button type="button" class="btn btn-outline-secondary blood-cancel-btn-admin" data-bs-dismiss="modal">
                        <i class="fas fa-times me-2"></i>Cancel
                    </button>
                    <div>
                        <button type="button" class="btn btn-outline-primary blood-prev-btn-admin" style="display: none;">
                            <i class="fas fa-arrow-left me-2"></i>Previous
                        </button>
                        <button type="button" class="btn btn-primary blood-next-btn-admin">
                            Next <i class="fas fa-arrow-right ms-2"></i>
                        </button>
                        <button type="button" class="btn btn-success blood-submit-btn-admin" style="display: none;">
...
.blood-step-content-admin { display: none; }
.blood-step-content-admin.active { display: block; }
.modal-backdrop { z-index: 1055 !important; }
#bloodCollectionModalAdmin { z-index: 1060 !important; }

/* Force time inputs to be always editable */
#blood-start-time-admin,
#blood-end-time-admin {
...
#blood-start-time-admin:disabled,
#blood-end-time-admin:disabled {
    background-color: #fff !important;
    opacity: 1 !important;
}
