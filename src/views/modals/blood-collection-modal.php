 ...
 * This file contains the HTML structure for the blood collection modal
 * Used in the phlebotomist workflow process
 */
?>
        ...
        <div class="modal-content" style="border-radius: 15px; border: none; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3);">
            ...
            <div class="modal-body" style="padding: 1.5rem; background-color: #ffffff; max-height: 70vh; overflow-y: auto;">
                <form id="bloodCollectionForm">
                    ...
                    <div class="blood-step-content active" data-step="1">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="bag-option" style="border: 2px solid #e9ecef; border-radius: 10px; padding: 1rem; cursor: pointer; transition: all 0.3s ease;">
                                    <label style="cursor: pointer; margin: 0; display: flex; align-items: center; gap: 10px;">
                                        <input type="radio" name="blood_bag_type" value="Single" style="margin: 0;">
                                        <div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="bag-option" style="border: 2px solid #e9ecef; border-radius: 10px; padding: 1rem; cursor: pointer; transition: all 0.3s ease;">
                                    <label style="cursor: pointer; margin: 0; display: flex; align-items: center; gap: 10px;">
                                        <input type="radio" name="blood_bag_type" value="Multiple" style="margin: 0;">
                                        <div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="bag-option" style="border: 2px solid #e9ecef; border-radius: 10px; padding: 1rem; cursor: pointer; transition: all 0.3s ease;">
                                    <label style="cursor: pointer; margin: 0; display: flex; align-items: center; gap: 10px;">
                                        <input type="radio" name="blood_bag_type" value="Top & Bottom" style="margin: 0;">
                                        <div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="bag-option" style="border: 2px solid #e9ecef; border-radius: 10px; padding: 1rem; cursor: pointer; transition: all 0.3s ease;">
                                    <label style="cursor: pointer; margin: 0; display: flex; align-items: center; gap: 10px;">
                                        <input type="radio" name="blood_bag_type" value="Apheresis" style="margin: 0;">
                                        <div>
                    ...
                    <div class="blood-step-content" data-step="2" style="display: none;">
                        <div class="blood-step-title mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="unit_serial_number" class="form-label">Unit Serial Number *</label>
                                <input type="text" class="form-control" id="unit_serial_number" name="unit_serial_number" readonly>
                    ...
                    <!-- Step 3: Timing -->
                    <div class="blood-step-content" data-step="3" style="display: none;">
                        <div class="blood-step-title mb-4">
                    ...
                    <div class="blood-step-content" data-step="4" style="display: none;">
                        <div class="blood-step-title mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="blood-status-card" style="border: 2px solid #e9ecef; border-radius: 10px; padding: 1.5rem; cursor: pointer; transition: all 0.3s ease;">
                                    <label style="cursor: pointer; margin: 0; display: flex; align-items: center; gap: 15px;">
                                        <input type="radio" name="is_successful" value="true" style="margin: 0;">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="blood-status-card" style="border: 2px solid #e9ecef; border-radius: 10px; padding: 1.5rem; cursor: pointer; transition: all 0.3s ease;">
                                    <label style="cursor: pointer; margin: 0; display: flex; align-items: center; gap: 15px;">
                                        <input type="radio" name="is_successful" value="false" style="margin: 0;">
                                        <div class="text-center">
                        ...
                        <div id="donorReactionSection" style="display: none;">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                    ...
                    <div class="blood-step-content" data-step="5" style="display: none;">
                        <div class="blood-step-title mb-4">
                        ...
                        <div class="collection-summary" style="background: #f8f9fa; border-radius: 10px; padding: 1.5rem;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p><strong>Bag Type:</strong> <span id="summary_bag_type">-</span></p>
                                    <p><strong>Serial Number:</strong> <span id="summary_serial">-</span></p>
                                    <p><strong>Collection Date:</strong> <span id="summary_date">-</span></p>
                                </div>
                                <div class="col-md-6">
                                    <p><strong>Start Time:</strong> <span id="summary_start">-</span></p>
                                    <p><strong>End Time:</strong> <span id="summary_end">-</span></p>
...
<!-- Blood Collection Details Modal -->
<div class="modal fade" id="phlebotomistBloodCollectionDetailsModal" tabindex="-1" aria-labelledby="phlebotomistBloodCollectionDetailsModalLabel" aria-hidden="true" style="z-index: 1070;">
        ...
        <div class="modal-content" style="border-radius: 15px; border: none; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3);">
            <div class="modal-header" style="background: linear-gradient(135deg, #b22222 0%, #8b0000 100%); color: white; border-radius: 15px 15px 0 0;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title mb-0" id="phlebotomistBloodCollectionDetailsModalLabel">Blood Collection Details</h5>
                        <small class="text-white-50">Collection information and status</small>
                    </div>
                </div>
                <button type="button" class="btn-close btn-close-white phlebotomist-close-btn" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body" style="padding: 1.5rem;">
                ...
                <div class="donor-info-section mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong>Name:</strong> <span id="phlebotomist-donor-name">-</span></p>
                            <p><strong>Age & Gender:</strong> <span id="phlebotomist-donor-age-gender">-</span></p>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Donor ID:</strong> <span id="phlebotomist-donor-id">-</span></p>
                            <p><strong>Blood Type:</strong> <span id="phlebotomist-blood-type">-</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="collection-details-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="phlebotomist-collection-date" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Bag Type</label>
                            <input type="text" class="form-control" id="phlebotomist-bag-type" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Unit Serial Number</label>
                            <input type="text" class="form-control" id="phlebotomist-unit-serial" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Collection Status</label>
                            <input type="text" class="form-control" id="phlebotomist-collection-status" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Start Time</label>
                            <input type="text" class="form-control" id="phlebotomist-start-time" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">End Time</label>
                            <input type="text" class="form-control" id="phlebotomist-end-time" readonly>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Donor Reaction</label>
                            <textarea class="form-control" id="phlebotomist-donor-reaction" rows="3" readonly></textarea>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Expiration Date</label>
                            <input type="text" class="form-control" id="phlebotomist-expiration-date" readonly>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer" style="background: #f8f9fa; border-radius: 0 0 15px 15px;">
                <button type="button" class="btn btn-secondary phlebotomist-close-btn" data-bs-dismiss="modal">
                    <i class="fas fa-times me-2"></i>Close
                </button>
                <button type="button" class="btn btn-primary" id="editCollectionBtn">
