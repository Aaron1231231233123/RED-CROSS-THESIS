...
<form method="POST" action="admin-declaration-form-process.php" id="modalAdminDeclarationForm">
    <input type="hidden" name="donor_id" value="<?php echo htmlspecialchars($donor_id); ?>">
    <input type="hidden" name="action" id="modalAdminDeclarationAction" value="">
</form>
...
<!-- Data for JavaScript -->
<script type="application/json" id="modalAdminDeclarationData">
{
...
console.log('Admin declaration form modal content loaded with screening data');
...
if (typeof window.printAdminDeclaration !== 'function') {
...
if (typeof window.submitAdminDeclarationForm !== 'function') {
    window.submitAdminDeclarationForm = function(event) {
        try {
            ...
            var form = document.getElementById('modalAdminDeclarationForm');
            if (!form) {
                alert('Form not found. Please try again.');
                return;
            }

            var actionInput = document.getElementById('modalAdminDeclarationAction');
            if (actionInput) {
