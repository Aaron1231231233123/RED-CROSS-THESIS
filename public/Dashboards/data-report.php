...
<head>
    ...
    <style>
        ...
        .report-kpi-row{margin-bottom:18px;}
        .report-kpi-card{
            background:#fff;
            border-radius:10px;
        ...
        @media print{
            ...
            /* Allow sections to split across pages to avoid large blank gaps */
            .report-section{page-break-inside:auto;}
            .report-group-title{page-break-after:avoid;}
...
<body>
    <div class="report-shell" id="dataReportRoot">
        ...
        <div class="row g-2 report-kpi-row">
            <div class="col-6 col-md-4 col-lg-2">
                <div class="report-kpi-card">
                    <div class="report-kpi-label">Total Active Donors</div>
                    <div class="report-kpi-value" id="kpiActiveDonors">-</div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2">
                <div class="report-kpi-card">
                    <div class="report-kpi-label">Eligible Donors Today</div>
                    <div class="report-kpi-value" id="kpiEligibleToday">-</div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2">
                <div class="report-kpi-card">
                    <div class="report-kpi-label">Total Blood Units Available</div>
                    <div class="report-kpi-value" id="kpiUnitsAvailable">-</div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2">
                <div class="report-kpi-card">
                    <div class="report-kpi-label">Units Nearing Expiry (7 days)</div>
                    <div class="report-kpi-value" id="kpiUnitsNearingExpiry">-</div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2">
                <div class="report-kpi-card">
                    <div class="report-kpi-label">Hospital Requests Today</div>
                    <div class="report-kpi-value" id="kpiHospitalRequestsToday">-</div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2">
                <div class="report-kpi-card">
                    <div class="report-kpi-label">Total Forecasted Demand</div>
                    <div class="report-kpi-value" id="kpiForecastDemand">-</div>
                </div>
            </div>
        </div>
